  ...
  return (
    <View style={styles.cvSection}>
      <View style={styles.cvSectionHeader}>
        <View
          style={[
            styles.cvSectionIcon,
            { backgroundColor: `${colors.primary}15` },
          ]}
        >
          <Ionicons name={icon} size={14} color={colors.primary} />
        </View>
        <Text style={[styles.cvSectionTitle, { color: colors.text }]}>
          {title}
        </Text>
        <View
          style={[styles.cvSectionLine, { backgroundColor: colors.border }]}
        />
      </View>
      {children}
    </View>
...
function CVRow({
  ...
  return (
    <View style={styles.cvRow}>
      <Text style={[styles.cvRowLabel, { color: colors.textMuted }]}>
        {label}
      </Text>
      <Text style={[styles.cvRowValue, { color: valueColor ?? colors.text }]}>
        {value}
      </Text>
    </View>
  );
    ...
    >
      ...
      >
        ...
        <View style={styles.avatarRing}>
          ...
          <View
            style={[styles.onlineDot, { borderColor: colors.primaryDeep }]}
          />
        </View>
        ...
        <View style={styles.statsStrip}>
          ...
          />
          <View style={styles.statItem}>
            <Text style={[styles.statValue, { color: "#4EADFF" }]}>
              {totalSKS}
            </Text>
      ...
      <View style={styles.body}>
        ...
        <View style={styles.footer}>
          <LinearGradient
            colors={["#4EADFF", "#7B6FF0"]}
            style={styles.footerLogo}
          >
            <Text style={styles.footerLogoText}>VK</Text>
          </LinearGradient>
          <Text style={[styles.footerApp, { color: colors.text }]}>
            VIND KLABAT
          </Text>
