...
export default function LecturerDashboard() {
  ...
  const respond = (name: string, action: "Accept" | "Decline") =>
    Alert.alert(
      `${action}ed`,
      `Request from ${name} has been ${action.toLowerCase()}ed.`,
    );
  ...
  return (
    ...
    >
      ...
      <View style={styles.body}>
        ...
        {/* My Courses */}
        <SectionHeader title="My Courses" action="View all" />
            ...
            >
              <Card style={styles.courseCard}>
                ...
                <View style={styles.courseInfo}>
                  ...
                  <Text
                    style={[styles.courseMeta, { color: colors.textMuted }]}
                  >
        ...
        <View style={styles.requestsHeader}>
          ...
          <View
            style={[styles.requestsBadge, { backgroundColor: colors.danger }]}
          >
          ...
          <Card key={r.id} style={styles.requestCard}>
            ...
            <View style={styles.reqBtns}>
              ...
              <TouchableOpacity
                ...
                onPress={() => respond(r.name, "Decline")}
                activeOpacity={0.8}
              >
                <Ionicons name="close" size={14} color={colors.textMuted} />
                <Text
                  style={[styles.rejectBtnText, { color: colors.textMuted }]}
                >
                  Decline
                </Text>
              </TouchableOpacity>
