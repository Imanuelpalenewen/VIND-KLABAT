  ...
  if (!courses) {
    return (
      <View style={[styles.loading, { backgroundColor: colors.bg }]}>
        <Text style={{ color: colors.textMuted }}>Memuat mata kuliah...</Text>
      </View>
    );
  }
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.sub}>Pengajaran Aktif</Text>
        ...
        <View style={styles.summaryRow}>
          <View style={styles.summaryChip}>
            ...
            <Text style={styles.summaryLabel}>Mata Kuliah</Text>
          </View>
        </View>
      </LinearGradient>

      <View style={styles.body}>
        <SectionHeader title="Daftar Mata Kuliah" />
