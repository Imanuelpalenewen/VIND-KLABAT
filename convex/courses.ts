// ─── Courses — Dev 1 (enroll/drop) & Dev 3 (lecturer) ───────────────────────
//
// TODO: getCoursesBySemester  (query, Dev 2 — untuk KRS page)
//   args: { semester: v.number() }
//   - Return semua MK di semester tersebut
//
// TODO: getEnrolledCourses    (query, Dev 1 — untuk jadwal & dashboard)
//   args: { studentId: v.id("users"), semester: v.number() }
//   - Join tabel enrollments dengan courses, return MK yang diambil mahasiswa
//
